...
$database = isset($_SESSION['database_asli']) ? $_SESSION['database_asli'] : 'dnet_ad2025';
...
if ($sqlconn->connect_errno) {
  // Try fallback logic here too if needed, but try-catch usually covers it for Unknown DB
