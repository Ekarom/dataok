...
?>
        ...
        <div class="modal-view-body">
            ...
            <!-- Detail Information -->
            <div class="view-section">
                <center><span class="view-section-title"><i class="fas fa-info-circle mr-1"></i> Detail Legalisir</span></center>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="view-value" style="align-items: flex-start; padding-top: 10px; height: auto;">
                            <i class="fas fa-align-left view-icon" style="margin-top: 3px;"></i> 
